...
// Componentes HTML compartidos embebidos
// ========================================

/**
 * Componentes HTML embebidos para evitar problemas de CORS
 */
const components = {
    navbar: `
<!-- Navbar -->
...
/**
 * Carga un componente HTML embebido
...
function loadComponent(componentName, containerId) {
    ...
    if (container && components[componentName]) {
        ...
        console.error(`❌ Componente ${componentName} o contenedor ${containerId} no encontrado`);
    }
}
...
function loadAuthComponents() {
    ...
    loadComponent('cartModal', 'cart-modal-container');
